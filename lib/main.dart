  ...
  Widget build(BuildContext context) {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView(
                        scrollDirection: Axis.horizontal,
                        children: [
                          buildContactAvatar('Milka','img.png'),
                          buildContactAvatar('Mum','img_1.png'),
                          buildContactAvatar('Mercy','img_2.png'),
                          buildContactAvatar('Maigret','img_3.png'),
                          buildContactAvatar('Maria','img_4.png'),
                          buildContactAvatar('Jane','img_5.png'),
                          buildContactAvatar('Jacob','img_6.png'),
                        ],
                      ),
                    )
                  ],
    ...
    topRight: Radius.circular(40))),
                  ...
                  child: ListView(
                    ...
                    'Jei','How are You?','img.png',0),
                      buildConversationRow(
                          'jane','will you come over?','img_1.png',2),
                      buildConversationRow(
                          'carol','How are You?','img_2.png',0),
                      buildConversationRow(
                          'jacob','Forgive me','img_3.png',3),
                      buildConversationRow(
                          'Ian','iam milly','img_4.png',6),
                      buildConversationRow(
                          'Agnes','How are You?','img_5.png',0),
                      buildConversationRow(
                          'lora','come along','img_6.png',2),
              ...
              children: [
                Column(
                  children:[
                    ...
                    const DrawerItem(title: 'Invite Friends', icon: Icons.people_outline),
